...
{	
	...
	var2 = (((((adc_T / 16) - ((int32_t)dig_T1)) * ((adc_T / 16) - ((int32_t)dig_T1))) / 4096) *
...
uint16_t BMP280_Read_16(uint8_t reg) //MSB:LSB
{
	...
	I2C_AckPositionConfig(I2C1, I2C_AckPosition_Next);
	while (!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_BYTE_RECEIVED));
	data16 |= I2C_ReceiveData(I2C1);
	
	I2C_AcknowledgeConfig(I2C1, DISABLE);
	while (!I2C_CheckEvent(I2C1, I2C_EVENT_MASTER_BYTE_RECEIVED));
	data16 |= (I2C_ReceiveData(I2C1) << 8);
